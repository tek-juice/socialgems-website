                    ...
                    <section className="mb-6 sm:mb-8 text-black">
                        ...
                        <section className="mb-6">
                            ...
                            <ul className="list-disc pl-6 mb-4">
                                ...
                                <li>not translate, merge, adapt, vary, alter or modify, 
                                    ...
                                    incorporated in, any other programs, except as 
                                ...
                                of the Copyright, Designs and Patents Act 1988) such actions cannot 
                                be prohibited because they are necessary to decompile the App to obtain 
                        ...
                        <section className="mb-6">
                            ...
                            <p>
                                ...
                                (not sold) to you. You have no intellectual property 
                                rights in, or to, the App, the Documentation or the 
                                Services other than the right to use them in accordance 
                                with these terms.
                            </p>
                        </section>
                        ...
                        <section className="mb-6">
                            ...
                            <p className="mb-4">
                                <strong>We do not exclude or limit in any way our liability 
                                    ...
                                    injury caused by our negligence or the negligence 
                        ...
                        <section className="mb-6">
                            ...
                            <p className="mb-4">
                                ...
                                do under these terms, or if we delay in taking steps 
                                against you in respect of your breaking this agreement, 
                                that will not mean that you do not have to do those 
